...
class admin_payment_refund extends ecjia_admin {
	...
	public function payment_refund_info() {
		...
		ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here(('退款流水'), RC_Uri::url('payment/admin_payment_record/init')));
		ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here('查看退款流水'));
		$this->assign('ur_here', '查看退款流水');
		$this->assign('action_link', array('text' => '退款流水', 'href' => RC_Uri::url('refund/admin_payment_refund/init')));
