...
class refund_cancel_module extends api_front implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {	
		...
		if (($refund_info['status'] == \Ecjia\App\Refund\Enums\RefundOrderEnum::ORDER_CANCELED) || (($refund_info['status'] == Ecjia\App\Refund\RefundStatus::ORDER_AGREE) && $refund_info['refund_status'] == Ecjia\App\Refund\RefundStatus::PAY_TRANSFERED)) {
