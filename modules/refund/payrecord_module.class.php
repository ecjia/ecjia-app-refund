...
class payrecord_module extends api_front implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
		...
		//应退总金额
		$back_amount = ($refund_order_info['surplus'] + $refund_order_info['money_paid']) - $refund_order_info['shipping_fee'];
		$back_account= '';
		...
		$arr = array(
				...
				'back_amount'				=> sprintf("%.2f", $back_amount),
				'format_back_amount'		=> price_format($back_amount),
