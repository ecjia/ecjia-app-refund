...
<div class="panel panel-body">
	<div class="return-time-base">
		<ul>
			...
			<li>
				<div class="{if $refund_info.status eq '1' or $refund_info.status eq '11'}step-cur{elseif $refund_info.status gt '0'}step-done{/if}">
					<div class="step-no">{if $refund_info.refund_status eq '0'}2{/if}</div>
